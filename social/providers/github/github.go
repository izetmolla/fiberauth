...
// This package can be used as a reference implementation of an OAuth2 provider for Auth.
package github
...
// Provider is the implementation of `social.Provider` for accessing Github.
...
func userFromReader(reader io.Reader, user *social.User) error {
	u := struct {
		ID       int    `json:"id"`
